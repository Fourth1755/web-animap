...
export default async function Page({ params }: any){
    ...
    return(
        <>
            <SeasonWallPaper seasonal="summer" year={year} />
            <SeasonalYearBar seasonalAndYear={seasonalAndYear} seasonal="summer" year={year}/>
            <SeasonalAnime seasonal="summer" year={year}/>
        </>
    )
}