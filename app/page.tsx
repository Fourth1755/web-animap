...
export default async function Home() {
  ...
  const animesSwordArtOnline = await animeService.getAnimesByCategoryUniverse('0196cf20-c309-7911-b85d-d06bd970e9c0')
  const animeSchool = await animeService.getAnimesByCategory('0198dca9-86c6-7df7-ba08-e8b1b1256324')
  const animeOnePiece = await animeService.getAnimesByCategoryUniverse('0196cf34-338a-7651-b248-69383e5be551')
  const animeStudioGibi = await animeService.getAnimesByStudio('019566fd-0842-7206-b22f-2b9b89ea46b4')
  const animeStudioA1 = await animeService.getAnimesByStudio('019566f2-46cb-78bb-aeea-56bf7bca0248')
  const animeRomance = await animeService.getAnimesByCategory('0198dca9-86c0-7929-b0d6-1a585bb9ac74')
  const fantasy = await animeService.getAnimesByCategory('0198e19c-3cb8-7d80-a7e1-d9679b5c6fa8')
  const drama = await animeService.getAnimesByCategory('0198e19b-e8fc-7bcb-85db-ca1e9b0fcaed')
  const adventure = await animeService.getAnimesByCategory('0198e19b-e581-76a2-8009-786f45f6b22d')
  const ufotable = await animeService.getAnimesByStudio('019566fa-dc59-7258-bc3f-f3d9f0f6c182')
  const fate = await animeService.getAnimesByCategoryUniverse('0196cf24-771e-768e-91c8-8395498f90e4')
  const action = await animeService.getAnimesByCategory('0198e19b-f5a7-745a-a8db-845a56f830bd')
  const doraemon = await animeService.getAnimesByCategoryUniverse('0199de4d-dbd9-797a-b8e8-ce0dcc7e1106')
